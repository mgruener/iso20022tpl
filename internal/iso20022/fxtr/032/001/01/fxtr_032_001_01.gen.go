...
type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.032.001.01 Dt"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.032.001.01 DtTm"`
}

type DateFormat18Choice struct {
	Dt         DateAndDateTimeChoice `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.032.001.01 Dt"`
	NotSpcfdDt DateType8Code         `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.032.001.01 NotSpcfdDt"`
}
