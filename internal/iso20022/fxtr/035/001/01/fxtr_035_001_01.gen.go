...
type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.035.001.01 Dt"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.035.001.01 DtTm"`
}

type DateFormat18Choice struct {
	Dt         DateAndDateTimeChoice `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.035.001.01 Dt"`
	NotSpcfdDt DateType8Code         `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.035.001.01 NotSpcfdDt"`
}
...
type IdentificationSource1Choice struct {
	Dmst  CountryCode `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.035.001.01 Dmst"`
	Prtry Max35Text   `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.035.001.01 Prtry"`
}
...
type PartyIdentification19Choice struct {
	NmAndAdr NameAndAddress8       `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.035.001.01 NmAndAdr"`
	AnyBIC   PartyIdentification44 `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.035.001.01 AnyBIC"`
}
...
type SecurityIdentification22Choice struct {
	ISIN     ISINOct2015Identifier                 `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.035.001.01 ISIN"`
	AltrnId  AlternateIdentification1              `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.035.001.01 AltrnId"`
	RIC      RICIdentifier                         `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.035.001.01 RIC"`
	TckrSymb TickerIdentifier                      `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.035.001.01 TckrSymb"`
	Blmbrg   BloombergIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.035.001.01 Blmbrg"`
	CTA      ConsolidatedTapeAssociationIdentifier `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.035.001.01 CTA"`
	Cmon     EuroclearClearstreamIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.035.001.01 Cmon"`
}
