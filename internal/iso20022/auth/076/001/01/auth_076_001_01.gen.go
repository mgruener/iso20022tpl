...
type PartyIdentification120Choice struct {
	AnyBIC   AnyBICDec2014Identifier `xml:"urn:iso:std:iso:20022:tech:xsd:auth.076.001.01 AnyBIC"`
	PrtryId  GenericIdentification36 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.076.001.01 PrtryId"`
	NmAndAdr NameAndAddress5         `xml:"urn:iso:std:iso:20022:tech:xsd:auth.076.001.01 NmAndAdr"`
}
...
type PartyReport1Choice struct {
	Upd PartyUpdate1       `xml:"urn:iso:std:iso:20022:tech:xsd:auth.076.001.01 Upd"`
	Cxl PartyCancellation1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.076.001.01 Cxl"`
}
...
type Period4Choice struct {
	Dt       ISODate `xml:"urn:iso:std:iso:20022:tech:xsd:auth.076.001.01 Dt"`
	FrDt     ISODate `xml:"urn:iso:std:iso:20022:tech:xsd:auth.076.001.01 FrDt"`
	ToDt     ISODate `xml:"urn:iso:std:iso:20022:tech:xsd:auth.076.001.01 ToDt"`
	FrDtToDt Period2 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.076.001.01 FrDtToDt"`
}
...
type SupervisingAuthorityIdentification1Choice struct {
	PrtryId ExternalAuthorityIdentification1Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.076.001.01 PrtryId"`
	FullNm  Max350Text                           `xml:"urn:iso:std:iso:20022:tech:xsd:auth.076.001.01 FullNm"`
}
