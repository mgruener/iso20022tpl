...
type SecuritiesAccountModification2Choice struct {
	SysSctiesAcct SystemSecuritiesAccount5 `xml:"urn:iso:std:iso:20022:tech:xsd:reda.023.001.01 SysSctiesAcct"`
	SysRstrctn    SystemRestriction1       `xml:"urn:iso:std:iso:20022:tech:xsd:reda.023.001.01 SysRstrctn"`
	MktSpcfcAttr  MarketSpecificAttribute1 `xml:"urn:iso:std:iso:20022:tech:xsd:reda.023.001.01 MktSpcfcAttr"`
}
