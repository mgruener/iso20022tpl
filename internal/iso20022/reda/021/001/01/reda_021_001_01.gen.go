...
type ErrorHandling3Choice struct {
	Cd    ExternalSystemErrorHandling1Code `xml:"urn:iso:std:iso:20022:tech:xsd:reda.021.001.01 Cd"`
	Prtry Max35Text                        `xml:"urn:iso:std:iso:20022:tech:xsd:reda.021.001.01 Prtry"`
}
...
type PartyIdentification120Choice struct {
	AnyBIC   AnyBICDec2014Identifier `xml:"urn:iso:std:iso:20022:tech:xsd:reda.021.001.01 AnyBIC"`
	PrtryId  GenericIdentification36 `xml:"urn:iso:std:iso:20022:tech:xsd:reda.021.001.01 PrtryId"`
	NmAndAdr NameAndAddress5         `xml:"urn:iso:std:iso:20022:tech:xsd:reda.021.001.01 NmAndAdr"`
}
...
type RequestType2Choice struct {
	PmtCtrl RequestType1Code       `xml:"urn:iso:std:iso:20022:tech:xsd:reda.021.001.01 PmtCtrl"`
	Enqry   RequestType2Code       `xml:"urn:iso:std:iso:20022:tech:xsd:reda.021.001.01 Enqry"`
	Prtry   GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:reda.021.001.01 Prtry"`
}
...
type SecuritiesAccountOrBusinessError3Choice struct {
	SctiesAcct SystemSecuritiesAccount6 `xml:"urn:iso:std:iso:20022:tech:xsd:reda.021.001.01 SctiesAcct"`
	BizErr     []ErrorHandling5         `xml:"urn:iso:std:iso:20022:tech:xsd:reda.021.001.01 BizErr"`
}

type SecuritiesAccountOrOperationalError3Choice struct {
	SctiesAcctRpt []SecuritiesAccountReport3 `xml:"urn:iso:std:iso:20022:tech:xsd:reda.021.001.01 SctiesAcctRpt"`
	OprlErr       []ErrorHandling5           `xml:"urn:iso:std:iso:20022:tech:xsd:reda.021.001.01 OprlErr"`
}
...
type SystemPartyType1Choice struct {
	Cd    ExternalSystemPartyType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:reda.021.001.01 Cd"`
	Prtry Max35Text                    `xml:"urn:iso:std:iso:20022:tech:xsd:reda.021.001.01 Prtry"`
}
...
type SystemSecuritiesAccountType1Choice struct {
	Cd    SystemSecuritiesAccountType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:reda.021.001.01 Cd"`
	Prtry GenericIdentification30          `xml:"urn:iso:std:iso:20022:tech:xsd:reda.021.001.01 Prtry"`
}
