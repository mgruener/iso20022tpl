...
type CounterpartyIdentification3Choice struct {
	LEI         LEIIdentifier      `xml:"urn:iso:std:iso:20022:tech:xsd:auth.014.001.02 LEI"`
	SctrAndLctn SectorAndLocation1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.014.001.02 SctrAndLctn"`
	NmAndLctn   NameAndLocation1   `xml:"urn:iso:std:iso:20022:tech:xsd:auth.014.001.02 NmAndLctn"`
}
...
type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:auth.014.001.02 Dt"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:auth.014.001.02 DtTm"`
}
...
type ForeignExchangeSwap3Choice struct {
	DataSetActn ReportPeriodActivity3Code         `xml:"urn:iso:std:iso:20022:tech:xsd:auth.014.001.02 DataSetActn"`
	Tx          []ForeignExchangeSwapTransaction3 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.014.001.02 Tx"`
}
