...
type AgentCAMovementStatusAdviceV01 struct {
	...
	AgtCAElctnStsAdvcId      DocumentIdentification8              `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 AgtCAElctnStsAdvcId"`
	AgtCAGblDstrbtnStsAdvcId DocumentIdentification8              `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 AgtCAGblDstrbtnStsAdvcId"`
	AgtCAMvmntInstrId        DocumentIdentification8              `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 AgtCAMvmntInstrId"`
	AgtCAMvmntCxlReqId       DocumentIdentification8              `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 AgtCAMvmntCxlReqId"`
	CorpActnGnlInf           CorporateActionInformation1          `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 CorpActnGnlInf"`
	MvmntStsDtls             CorporateActionMovementStatus1Choice `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 MvmntStsDtls"`
	MvmntCxlStsDtls          CorporateMovementStatus2             `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 MvmntCxlStsDtls"`
}

type AlternateSecurityIdentification3 struct {
	Id         Max70Text   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 Id"`
	DmstIdSrc  CountryCode `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 DmstIdSrc"`
	PrtryIdSrc Max35Text   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 PrtryIdSrc"`
}
...
type CorporateActionEventProcessingType1FormatChoice struct {
	Cd    CorporateActionEventProcessingType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 Cd"`
	Prtry GenericIdentification13                 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 Prtry"`
}
...
type CorporateActionEventType2FormatChoice struct {
	Cd    CorporateActionEventType2Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 Cd"`
	Prtry GenericIdentification13       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 Prtry"`
}
...
type CorporateActionMandatoryVoluntary1FormatChoice struct {
	Cd    CorporateActionMandatoryVoluntary1Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 Cd"`
	Prtry GenericIdentification13                `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 Prtry"`
}
...
type CorporateActionMovementStatus1Choice struct {
	PrcdSts  CorporateActionMovementProcessingStatus1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 PrcdSts"`
	FaildSts CorporateActionMovementFailedStatus1     `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 FaildSts"`
	RjctdSts CorporateActionMovementRejectionStatus1  `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 RjctdSts"`
}
...
type FailedMovement1 struct {
	CshAmt    ActiveCurrencyAndAmount             `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 CshAmt"`
	SctiesQty UnitOrFaceAmount1Choice             `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 SctiesQty"`
...
type FailedSettlementReason1FormatChoice struct {
	Cd    FailedSettlementReason1Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 Cd"`
	Prtry GenericIdentification13     `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 Prtry"`
}
...
type PartyIdentification2Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 BICOrBEI"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 PrtryId"`
	NmAndAdr NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 NmAndAdr"`
}
...
type ProcessedStatus2FormatChoice struct {
	Cd    ProcessedStatus2Code    `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 Cd"`
	Prtry GenericIdentification13 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 Prtry"`
}
...
type ProcessedStatus3FormatChoice struct {
	Cd    ProcessedStatus3Code    `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 Cd"`
	Prtry GenericIdentification13 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 Prtry"`
}
...
type RejectionReason13FormatChoice struct {
	Cd    RejectionReason13Code   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 Cd"`
	Prtry GenericIdentification13 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 Prtry"`
}
...
type RejectionReason14FormatChoice struct {
	Cd    RejectionReason14Code   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 Cd"`
	Prtry GenericIdentification13 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 Prtry"`
}

type SecurityIdentification7 struct {
	ISIN   ISINIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 ISIN"`
	OthrId AlternateSecurityIdentification3 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 OthrId"`
	Desc   Max140Text                       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 Desc,omitempty"`
}

type UnitOrFaceAmount1Choice struct {
	Unit    float64                 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 Unit"`
	FaceAmt ActiveCurrencyAndAmount `xml:"urn:iso:std:iso:20022:tech:xsd:seev.022.001.01 FaceAmt"`
}
