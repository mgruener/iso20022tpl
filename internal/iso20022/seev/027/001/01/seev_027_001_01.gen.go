...
type AgentCAStandingInstructionStatusAdviceV01 struct {
	...
	AgtCAStgInstrReqId    DocumentIdentification8                               `xml:"urn:iso:std:iso:20022:tech:xsd:seev.027.001.01 AgtCAStgInstrReqId"`
	AgtCAStgInstrCxlReqId DocumentIdentification8                               `xml:"urn:iso:std:iso:20022:tech:xsd:seev.027.001.01 AgtCAStgInstrCxlReqId"`
	...
	StgInstrReqSts        StandingInstructionStatus1Choice                      `xml:"urn:iso:std:iso:20022:tech:xsd:seev.027.001.01 StgInstrReqSts"`
	StgInstrCxlReqSts     StandingInstructionCancellationStatus1Choice          `xml:"urn:iso:std:iso:20022:tech:xsd:seev.027.001.01 StgInstrCxlReqSts"`
}

type AlternateSecurityIdentification3 struct {
	Id         Max70Text   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.027.001.01 Id"`
	DmstIdSrc  CountryCode `xml:"urn:iso:std:iso:20022:tech:xsd:seev.027.001.01 DmstIdSrc"`
	PrtryIdSrc Max35Text   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.027.001.01 PrtryIdSrc"`
}
...
type CorporateActionEventType2FormatChoice struct {
	Cd    CorporateActionEventType2Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.027.001.01 Cd"`
	Prtry GenericIdentification13       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.027.001.01 Prtry"`
}
...
type PartyIdentification2Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.027.001.01 BICOrBEI"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.027.001.01 PrtryId"`
	NmAndAdr NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:seev.027.001.01 NmAndAdr"`
}
...
type ProcessedStatus3FormatChoice struct {
	Cd    ProcessedStatus3Code    `xml:"urn:iso:std:iso:20022:tech:xsd:seev.027.001.01 Cd"`
	Prtry GenericIdentification13 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.027.001.01 Prtry"`
}
...
type ProcessedStatus4FormatChoice struct {
	Cd    ProcessedStatus4Code    `xml:"urn:iso:std:iso:20022:tech:xsd:seev.027.001.01 Cd"`
	Prtry GenericIdentification13 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.027.001.01 Prtry"`
}
...
type RejectionReason10FormatChoice struct {
	Cd    RejectionReason10Code   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.027.001.01 Cd"`
	Prtry GenericIdentification13 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.027.001.01 Prtry"`
}
...
type RejectionReason20FormatChoice struct {
	Cd    RejectionReason20Code   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.027.001.01 Cd"`
	Prtry GenericIdentification13 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.027.001.01 Prtry"`
}

type SecurityIdentification7 struct {
	ISIN   ISINIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.027.001.01 ISIN"`
	OthrId AlternateSecurityIdentification3 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.027.001.01 OthrId"`
...
type StandingInstructionCancellationStatus1Choice struct {
	PrcdSts  CorporateActionStandingInstructionCancellationProcessingStatus1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.027.001.01 PrcdSts"`
	RjctdSts CorporateActionStandingInstructionCancellationRejectionStatus1  `xml:"urn:iso:std:iso:20022:tech:xsd:seev.027.001.01 RjctdSts"`
}

type StandingInstructionStatus1Choice struct {
	PrcdSts  CorporateActionStandingInstructionProcessingStatus1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.027.001.01 PrcdSts"`
	RjctdSts CorporateActionStandingInstructionRejectionStatus1  `xml:"urn:iso:std:iso:20022:tech:xsd:seev.027.001.01 RjctdSts"`
}
