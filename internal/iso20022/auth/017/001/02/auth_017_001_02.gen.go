...
type AssetClassCommodity3Choice struct {
	Agrcltrl          AssetClassCommodityAgricultural1Choice         `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Agrcltrl"`
	Nrgy              AssetClassCommodityEnergy1Choice               `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Nrgy"`
	Envttl            AssetClassCommodityEnvironmental1Choice        `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Envttl"`
	Frtlzr            AssetClassCommodityFertilizer1Choice           `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Frtlzr"`
	Frght             AssetClassCommodityFreight1Choice              `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Frght"`
	IndstrlPdct       AssetClassCommodityIndustrialProduct1Choice    `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 IndstrlPdct"`
	Metl              AssetClassCommodityMetal1Choice                `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Metl"`
	OthrC10           AssetClassCommodityOtherC102Choice             `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 OthrC10"`
	Ppr               AssetClassCommodityPaper1Choice                `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Ppr"`
	Plprpln           AssetClassCommodityPolypropylene1Choice        `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Plprpln"`
	Infltn            AssetClassCommodityInflation1                  `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Infltn"`
	MultiCmmdtyExtc   AssetClassCommodityMultiCommodityExotic1       `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 MultiCmmdtyExtc"`
	OffclEcnmcSttstcs AssetClassCommodityOfficialEconomicStatistics1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 OffclEcnmcSttstcs"`
	Othr              AssetClassCommodityOther1                      `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Othr"`
}

type AssetClassCommodityAgricultural1Choice struct {
	GrnOilSeed AgriculturalCommodityOilSeed1   `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 GrnOilSeed"`
	Soft       AgriculturalCommoditySoft1      `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Soft"`
	Ptt        AgriculturalCommodityPotato1    `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Ptt"`
	OlvOil     AgriculturalCommodityOliveOil1  `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 OlvOil"`
	Dairy      AgriculturalCommodityDairy1     `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Dairy"`
	Frstry     AgriculturalCommodityForestry1  `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Frstry"`
	Sfd        AgriculturalCommoditySeafood1   `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Sfd"`
	LiveStock  AgriculturalCommodityLiveStock1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 LiveStock"`
	Grn        AgriculturalCommodityGrain1     `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Grn"`
}

type AssetClassCommodityEnergy1Choice struct {
	Elctrcty  EnergyCommodityElectricity1     `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Elctrcty"`
	NtrlGas   EnergyCommodityNaturalGas1      `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 NtrlGas"`
	Oil       EnergyCommodityOil1             `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Oil"`
	Coal      EnergyCommodityCoal1            `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Coal"`
	IntrNrgy  EnergyCommodityInterEnergy1     `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 IntrNrgy"`
	RnwblNrgy EnergyCommodityRenewableEnergy1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 RnwblNrgy"`
	LghtEnd   EnergyCommodityLightEnd1        `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 LghtEnd"`
	Dstllts   EnergyCommodityDistillates1     `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Dstllts"`
}

type AssetClassCommodityEnvironmental1Choice struct {
	Emssns   EnvironmentalCommodityEmission1      `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Emssns"`
	Wthr     EnvironmentalCommodityWeather1       `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Wthr"`
	CrbnRltd EnvironmentalCommodityCarbonRelated1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 CrbnRltd"`
}

type AssetClassCommodityFertilizer1Choice struct {
	Ammn             FertilizerCommodityAmmonia1                `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Ammn"`
	DmmnmPhspht      FertilizerCommodityDiammoniumPhosphate1    `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 DmmnmPhspht"`
	Ptsh             FertilizerCommodityPotash1                 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Ptsh"`
	Slphr            FertilizerCommoditySulphur1                `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Slphr"`
	Urea             FertilizerCommodityUrea1                   `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Urea"`
	UreaAndAmmnmNtrt FertilizerCommodityUreaAndAmmoniumNitrate1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 UreaAndAmmnmNtrt"`
}

type AssetClassCommodityFreight1Choice struct {
	Dry       FreightCommodityDry1           `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Dry"`
	Wet       FreightCommodityWet1           `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Wet"`
	CntnrShip FreightCommodityContainerShip1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 CntnrShip"`
}

type AssetClassCommodityIndustrialProduct1Choice struct {
	Cnstrctn IndustrialProductCommodityConstruction1  `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Cnstrctn"`
	Manfctg  IndustrialProductCommodityManufacturing1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Manfctg"`
}
...
type AssetClassCommodityMetal1Choice struct {
	NonPrcs MetalCommodityNonPrecious1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 NonPrcs"`
	Prcs    MetalCommodityPrecious1    `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Prcs"`
}
...
type AssetClassCommodityOtherC102Choice struct {
	Dlvrbl    OtherC10CommodityDeliverable2    `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Dlvrbl"`
	NonDlvrbl OtherC10CommodityNonDeliverable2 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 NonDlvrbl"`
}

type AssetClassCommodityPaper1Choice struct {
	CntnrBrd PaperCommodityContainerBoard1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 CntnrBrd"`
	Nwsprnt  PaperCommodityNewsprint1      `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Nwsprnt"`
	Pulp     PaperCommodityPulp1           `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Pulp"`
	RcvrdPpr PaperCommodityRecoveredPaper1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 RcvrdPpr"`
}

type AssetClassCommodityPolypropylene1Choice struct {
	Plstc PolypropyleneCommodityPlastic1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Plstc"`
}
...
type BenchmarkCurveName5Choice struct {
	Indx BenchmarkCurveName2Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Indx"`
	Nm   Max25Text               `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Nm"`
}

type BenchmarkCurveName6Choice struct {
	ISIN ISINOct2015Identifier   `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 ISIN"`
	Indx BenchmarkCurveName2Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Indx"`
	Nm   Max25Text               `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Nm"`
}
...
type FinancialInstrument48Choice struct {
	ISIN ISINOct2015Identifier `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 ISIN"`
	LEI  LEIIdentifier         `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 LEI"`
	Indx FinancialInstrument58 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Indx"`
}
...
type FinancialInstrumentIdentification5Choice struct {
	Sngl FinancialInstrument48Choice `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Sngl"`
	Bskt FinancialInstrument53       `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Bskt"`
}
...
type InterestRate6Choice struct {
	Fxd  float64               `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Fxd"`
	Fltg FloatingInterestRate6 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Fltg"`
}

type InterestRate8Choice struct {
	Fxd  float64               `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Fxd"`
	Fltg FloatingInterestRate8 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Fltg"`
}
...
type Period4Choice struct {
	Dt       ISODate `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Dt"`
	FrDt     ISODate `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 FrDt"`
	ToDt     ISODate `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 ToDt"`
	FrDtToDt Period2 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 FrDtToDt"`
}
...
type SecuritiesTransactionPrice2Choice struct {
	MntryVal AmountAndDirection61 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 MntryVal"`
	Pctg     float64              `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Pctg"`
	Yld      float64              `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Yld"`
	BsisPts  float64              `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 BsisPts"`
}

type SecuritiesTransactionPrice4Choice struct {
	Pric   SecuritiesTransactionPrice2Choice `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Pric"`
	NoPric SecuritiesTransactionPrice1       `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 NoPric"`
}
...
type TradingVenueIdentification1Choice struct {
	MktIdCd          MICIdentifier               `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 MktIdCd"`
	NtlCmptntAuthrty CountryCode                 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 NtlCmptntAuthrty"`
	Othr             TradingVenueIdentification2 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.017.001.02 Othr"`
}
