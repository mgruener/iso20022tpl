...
type CounterpartyTradeNature5Choice struct {
	FI           []FinancialPartySectorType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.090.001.01 FI"`
	NFI          NonFinancialInstitutionSector2  `xml:"urn:iso:std:iso:20022:tech:xsd:auth.090.001.01 NFI"`
	CntrlCntrPty NoReasonCode                    `xml:"urn:iso:std:iso:20022:tech:xsd:auth.090.001.01 CntrlCntrPty"`
	Othr         NoReasonCode                    `xml:"urn:iso:std:iso:20022:tech:xsd:auth.090.001.01 Othr"`
}
...
type ExchangeRateBasis1Choice struct {
	CcyPair ExchangeRateBasis1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.090.001.01 CcyPair"`
	Prtry   Max52Text          `xml:"urn:iso:std:iso:20022:tech:xsd:auth.090.001.01 Prtry"`
}
...
type OrganisationIdentification7Choice struct {
	LEI  LEIIdentifier                `xml:"urn:iso:std:iso:20022:tech:xsd:auth.090.001.01 LEI"`
	Othr OrganisationIdentification30 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.090.001.01 Othr"`
}

type OrganisationIdentification8Choice struct {
	ClntId Max50Text               `xml:"urn:iso:std:iso:20022:tech:xsd:auth.090.001.01 ClntId"`
	AnyBIC AnyBICDec2014Identifier `xml:"urn:iso:std:iso:20022:tech:xsd:auth.090.001.01 AnyBIC"`
}
...
type PositionSetAggregated1Choice struct {
	DataSetActn ReportPeriodActivity1Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.090.001.01 DataSetActn"`
	Rpt         PositionSetAggregated3    `xml:"urn:iso:std:iso:20022:tech:xsd:auth.090.001.01 Rpt"`
}
...
type SecurityIdentification18Choice struct {
	ISIN            ISINOct2015Identifier `xml:"urn:iso:std:iso:20022:tech:xsd:auth.090.001.01 ISIN"`
	AltrntvInstrmId Max52Text             `xml:"urn:iso:std:iso:20022:tech:xsd:auth.090.001.01 AltrntvInstrmId"`
}

type SecurityIdentification34Choice struct {
	ISIN            ISINOct2015Identifier            `xml:"urn:iso:std:iso:20022:tech:xsd:auth.090.001.01 ISIN"`
	AltrntvInstrmId Max52Text                        `xml:"urn:iso:std:iso:20022:tech:xsd:auth.090.001.01 AltrntvInstrmId"`
	UnqPdctIdr      Max52Text                        `xml:"urn:iso:std:iso:20022:tech:xsd:auth.090.001.01 UnqPdctIdr"`
	BsktCnsttnts    []SecurityIdentification18Choice `xml:"urn:iso:std:iso:20022:tech:xsd:auth.090.001.01 BsktCnsttnts"`
	Indx            SecurityIdentification35Choice   `xml:"urn:iso:std:iso:20022:tech:xsd:auth.090.001.01 Indx"`
	IdNotAvlbl      UnderlyingIdentification1Code    `xml:"urn:iso:std:iso:20022:tech:xsd:auth.090.001.01 IdNotAvlbl"`
}

type SecurityIdentification35Choice struct {
	ISIN ISINOct2015Identifier   `xml:"urn:iso:std:iso:20022:tech:xsd:auth.090.001.01 ISIN"`
	Nm   Max350Text              `xml:"urn:iso:std:iso:20022:tech:xsd:auth.090.001.01 Nm"`
	Indx BenchmarkCurveName3Code `xml:"urn:iso:std:iso:20022:tech:xsd:auth.090.001.01 Indx"`
}
...
type TimeToMaturity1Choice struct {
	Prd  TimeToMaturityPeriod1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.090.001.01 Prd"`
	Spcl SpecialPurpose2Code   `xml:"urn:iso:std:iso:20022:tech:xsd:auth.090.001.01 Spcl"`
}
