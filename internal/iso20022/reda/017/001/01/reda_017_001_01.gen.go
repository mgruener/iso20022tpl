...
type AddressType3Choice struct {
	Cd    AddressType2Code        `xml:"urn:iso:std:iso:20022:tech:xsd:reda.017.001.01 Cd"`
	Prtry GenericIdentification30 `xml:"urn:iso:std:iso:20022:tech:xsd:reda.017.001.01 Prtry"`
}
...
type ErrorHandling2Choice struct {
	Cd    ErrorHandling1Code `xml:"urn:iso:std:iso:20022:tech:xsd:reda.017.001.01 Cd"`
	Prtry Max35Text          `xml:"urn:iso:std:iso:20022:tech:xsd:reda.017.001.01 Prtry"`
}

type ErrorHandling3Choice struct {
	Cd    ExternalSystemErrorHandling1Code `xml:"urn:iso:std:iso:20022:tech:xsd:reda.017.001.01 Cd"`
	Prtry Max35Text                        `xml:"urn:iso:std:iso:20022:tech:xsd:reda.017.001.01 Prtry"`
}
...
type PartyIdentification120Choice struct {
	AnyBIC   AnyBICDec2014Identifier `xml:"urn:iso:std:iso:20022:tech:xsd:reda.017.001.01 AnyBIC"`
	PrtryId  GenericIdentification36 `xml:"urn:iso:std:iso:20022:tech:xsd:reda.017.001.01 PrtryId"`
	NmAndAdr NameAndAddress5         `xml:"urn:iso:std:iso:20022:tech:xsd:reda.017.001.01 NmAndAdr"`
}
...
type PartyOrBusinessError3Choice struct {
	SysPty SystemParty5     `xml:"urn:iso:std:iso:20022:tech:xsd:reda.017.001.01 SysPty"`
	BizErr []ErrorHandling4 `xml:"urn:iso:std:iso:20022:tech:xsd:reda.017.001.01 BizErr"`
}

type PartyOrOperationalError3Choice struct {
	PtyRpt  []PartyReport3   `xml:"urn:iso:std:iso:20022:tech:xsd:reda.017.001.01 PtyRpt"`
	OprlErr []ErrorHandling5 `xml:"urn:iso:std:iso:20022:tech:xsd:reda.017.001.01 OprlErr"`
}
...
type RequestType2Choice struct {
	PmtCtrl RequestType1Code       `xml:"urn:iso:std:iso:20022:tech:xsd:reda.017.001.01 PmtCtrl"`
	Enqry   RequestType2Code       `xml:"urn:iso:std:iso:20022:tech:xsd:reda.017.001.01 Enqry"`
	Prtry   GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:reda.017.001.01 Prtry"`
}
...
type SystemPartyType1Choice struct {
	Cd    ExternalSystemPartyType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:reda.017.001.01 Cd"`
	Prtry Max35Text                    `xml:"urn:iso:std:iso:20022:tech:xsd:reda.017.001.01 Prtry"`
}
...
type TechnicalIdentification2Choice struct {
	BICFI   BICFIDec2014Identifier `xml:"urn:iso:std:iso:20022:tech:xsd:reda.017.001.01 BICFI"`
	TechAdr Max256Text             `xml:"urn:iso:std:iso:20022:tech:xsd:reda.017.001.01 TechAdr"`
}
