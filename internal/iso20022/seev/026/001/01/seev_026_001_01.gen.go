...
type AlternateSecurityIdentification3 struct {
	...
	DmstIdSrc  CountryCode `xml:"urn:iso:std:iso:20022:tech:xsd:seev.026.001.01 DmstIdSrc"`
	PrtryIdSrc Max35Text   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.026.001.01 PrtryIdSrc"`
}
...
type CashAccountIdentification1Choice struct {
	IBAN     IBANIdentifier                  `xml:"urn:iso:std:iso:20022:tech:xsd:seev.026.001.01 IBAN"`
	BBAN     BBANIdentifier                  `xml:"urn:iso:std:iso:20022:tech:xsd:seev.026.001.01 BBAN"`
	UPIC     UPICIdentifier                  `xml:"urn:iso:std:iso:20022:tech:xsd:seev.026.001.01 UPIC"`
	DmstAcct SimpleIdentificationInformation `xml:"urn:iso:std:iso:20022:tech:xsd:seev.026.001.01 DmstAcct"`
}
...
type CorporateActionEventType2FormatChoice struct {
	Cd    CorporateActionEventType2Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.026.001.01 Cd"`
	Prtry GenericIdentification13       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.026.001.01 Prtry"`
}

type CorporateActionStandingInstruction1 struct {
	NetOrGrss         StandingInstructionGrossNet1Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.026.001.01 NetOrGrss"`
	CshDstrbtnDtls    CashAccount17                    `xml:"urn:iso:std:iso:20022:tech:xsd:seev.026.001.01 CshDstrbtnDtls"`
	SctiesDstrbtnDtls SecuritiesAccount6               `xml:"urn:iso:std:iso:20022:tech:xsd:seev.026.001.01 SctiesDstrbtnDtls"`
...
type PartyIdentification2Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.026.001.01 BICOrBEI"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.026.001.01 PrtryId"`
	NmAndAdr NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:seev.026.001.01 NmAndAdr"`
}
...
type SecurityIdentification7 struct {
	ISIN   ISINIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.026.001.01 ISIN"`
	OthrId AlternateSecurityIdentification3 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.026.001.01 OthrId"`
