...
type ClearingSystemIdentification2Choice struct {
	Cd    ExternalClearingSystemIdentification1Code `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.015.001.04 Cd"`
	Prtry Max35Text                                 `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.015.001.04 Prtry"`
}
...
type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.015.001.04 Dt"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.015.001.04 DtTm"`
}
...
type IdentificationSource3Choice struct {
	Cd    ExternalFinancialInstrumentIdentificationType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.015.001.04 Cd"`
	Prtry Max35Text                                          `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.015.001.04 Prtry"`
}
...
type MatchingSystemReference1Choice struct {
	MtchgSysUnqRef Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.015.001.04 MtchgSysUnqRef"`
	RltdRef        Max35Text `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.015.001.04 RltdRef"`
}
...
type NDFOpeningFixing1Choice struct {
	OpngConds   OpeningConditions1 `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.015.001.04 OpngConds"`
	OpngConfRef Max35Text          `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.015.001.04 OpngConfRef"`
}
...
type PartyIdentification73Choice struct {
	NmAndAdr NameAndAddress8       `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.015.001.04 NmAndAdr"`
	AnyBIC   PartyIdentification44 `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.015.001.04 AnyBIC"`
	PtyId    PartyIdentification59 `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.015.001.04 PtyId"`
}
...
type RegulatoryReporting6 struct {
	...
	LkSwpId                Exact42Text                             `xml:"urn:iso:std:iso:20022:tech:xsd:fxtr.015.001.04 LkSwpId,omitempty"`
