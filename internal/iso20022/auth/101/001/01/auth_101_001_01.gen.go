...
type SettlementDataRate1Choice struct {
	NbOfInstrs  float64 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.101.001.01 NbOfInstrs"`
	ValOfInstrs float64 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.101.001.01 ValOfInstrs"`
}
