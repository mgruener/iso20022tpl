...
type AuditTrailOrBusinessError6Choice struct {
	AudtTrl []AuditTrail1    `xml:"urn:iso:std:iso:20022:tech:xsd:reda.037.001.01 AudtTrl"`
	BizErr  []ErrorHandling5 `xml:"urn:iso:std:iso:20022:tech:xsd:reda.037.001.01 BizErr"`
}
...
type DatePeriodSearch1Choice struct {
	FrDt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:reda.037.001.01 FrDt"`
	ToDt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:reda.037.001.01 ToDt"`
	FrToDt DatePeriod2 `xml:"urn:iso:std:iso:20022:tech:xsd:reda.037.001.01 FrToDt"`
	EQDt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:reda.037.001.01 EQDt"`
	NEQDt  ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:reda.037.001.01 NEQDt"`
}
...
type ErrorHandling3Choice struct {
	Cd    ExternalSystemErrorHandling1Code `xml:"urn:iso:std:iso:20022:tech:xsd:reda.037.001.01 Cd"`
	Prtry Max35Text                        `xml:"urn:iso:std:iso:20022:tech:xsd:reda.037.001.01 Prtry"`
}
...
type SecuritiesAccountAuditTrailOrOperationalError3Choice struct {
	SctiesAcctAudtTrlRpt []SecuritiesAccountAuditTrailReport3 `xml:"urn:iso:std:iso:20022:tech:xsd:reda.037.001.01 SctiesAcctAudtTrlRpt"`
	OprlErr              []ErrorHandling5                     `xml:"urn:iso:std:iso:20022:tech:xsd:reda.037.001.01 OprlErr"`
}
