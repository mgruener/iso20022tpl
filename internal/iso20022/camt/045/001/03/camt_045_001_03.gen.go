...
type AlternateSecurityIdentification1 struct {
	...
	DmstIdSrc  CountryCode `xml:"urn:swift:xsd:camt.045.001.03 DmstIdSrc"`
	PrtryIdSrc Max35Text   `xml:"urn:swift:xsd:camt.045.001.03 PrtryIdSrc"`
}

type AmountOrRate3Choice struct {
	Amt  ActiveCurrencyAnd13DecimalAmount `xml:"urn:swift:xsd:camt.045.001.03 Amt"`
	Rate float64                          `xml:"urn:swift:xsd:camt.045.001.03 Rate"`
}
...
type ChargeType4Choice struct {
	Cd    ChargeType12Code        `xml:"urn:swift:xsd:camt.045.001.03 Cd"`
	Prtry GenericIdentification47 `xml:"urn:swift:xsd:camt.045.001.03 Prtry"`
}
...
type CommissionType5Choice struct {
	Cd    CommissionType6Code     `xml:"urn:swift:xsd:camt.045.001.03 Cd"`
	Prtry GenericIdentification47 `xml:"urn:swift:xsd:camt.045.001.03 Prtry"`
}
...
type DataFormat2Choice struct {
	Strd  GenericIdentification1 `xml:"urn:swift:xsd:camt.045.001.03 Strd"`
	Ustrd Max140Text             `xml:"urn:swift:xsd:camt.045.001.03 Ustrd"`
}

type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:swift:xsd:camt.045.001.03 Dt"`
	DtTm ISODateTime `xml:"urn:swift:xsd:camt.045.001.03 DtTm"`
}
...
type InvestmentFundTransactionInType1Choice struct {
	Cd    InvestmentFundTransactionInType1Code `xml:"urn:swift:xsd:camt.045.001.03 Cd"`
	Prtry GenericIdentification47              `xml:"urn:swift:xsd:camt.045.001.03 Prtry"`
}
...
type InvestmentFundTransactionOutType1Choice struct {
	Cd    InvestmentFundTransactionOutType1Code `xml:"urn:swift:xsd:camt.045.001.03 Cd"`
	Prtry GenericIdentification47               `xml:"urn:swift:xsd:camt.045.001.03 Prtry"`
}
...
type PartyIdentification2Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:swift:xsd:camt.045.001.03 BICOrBEI"`
	PrtryId  GenericIdentification1 `xml:"urn:swift:xsd:camt.045.001.03 PrtryId"`
	NmAndAdr NameAndAddress5        `xml:"urn:swift:xsd:camt.045.001.03 NmAndAdr"`
}
...
type QuantityType1Choice struct {
	Cd    OrderQuantityType2Code  `xml:"urn:swift:xsd:camt.045.001.03 Cd"`
	Prtry GenericIdentification47 `xml:"urn:swift:xsd:camt.045.001.03 Prtry"`
}
...
type SecurityIdentification3Choice struct {
	ISIN        ISINIdentifier                        `xml:"urn:swift:xsd:camt.045.001.03 ISIN"`
	SEDOL       string                                `xml:"urn:swift:xsd:camt.045.001.03 SEDOL"`
	CUSIP       string                                `xml:"urn:swift:xsd:camt.045.001.03 CUSIP"`
	RIC         RICIdentifier                         `xml:"urn:swift:xsd:camt.045.001.03 RIC"`
	TckrSymb    TickerIdentifier                      `xml:"urn:swift:xsd:camt.045.001.03 TckrSymb"`
	Blmbrg      BloombergIdentifier                   `xml:"urn:swift:xsd:camt.045.001.03 Blmbrg"`
	CTA         ConsolidatedTapeAssociationIdentifier `xml:"urn:swift:xsd:camt.045.001.03 CTA"`
	QUICK       string                                `xml:"urn:swift:xsd:camt.045.001.03 QUICK"`
	Wrtppr      string                                `xml:"urn:swift:xsd:camt.045.001.03 Wrtppr"`
	Dtch        string                                `xml:"urn:swift:xsd:camt.045.001.03 Dtch"`
	Vlrn        string                                `xml:"urn:swift:xsd:camt.045.001.03 Vlrn"`
	SCVM        string                                `xml:"urn:swift:xsd:camt.045.001.03 SCVM"`
	Belgn       string                                `xml:"urn:swift:xsd:camt.045.001.03 Belgn"`
	Cmon        EuroclearClearstreamIdentifier        `xml:"urn:swift:xsd:camt.045.001.03 Cmon"`
	OthrPrtryId AlternateSecurityIdentification1      `xml:"urn:swift:xsd:camt.045.001.03 OthrPrtryId"`
}
...
type UnitPriceType2Choice struct {
	Cd    TypeOfPrice10Code       `xml:"urn:swift:xsd:camt.045.001.03 Cd"`
	Prtry GenericIdentification47 `xml:"urn:swift:xsd:camt.045.001.03 Prtry"`
}
