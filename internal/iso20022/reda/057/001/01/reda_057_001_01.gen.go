...
type ClassificationType1Choice struct {
	ClssfctnFinInstrm CFIOct2015Identifier   `xml:"urn:iso:std:iso:20022:tech:xsd:reda.057.001.01 ClssfctnFinInstrm"`
	AltrnClssfctn     GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:reda.057.001.01 AltrnClssfctn"`
}
...
type MarketIdentificationOrCashPurpose1Choice struct {
	SttlmInstrMktId MarketIdentification87    `xml:"urn:iso:std:iso:20022:tech:xsd:reda.057.001.01 SttlmInstrMktId"`
	CshSSIPurp      []ExternalMarketArea1Code `xml:"urn:iso:std:iso:20022:tech:xsd:reda.057.001.01 CshSSIPurp"`
}
...
type PartyIdentification75Choice struct {
	AnyBIC   AnyBICIdentifier `xml:"urn:iso:std:iso:20022:tech:xsd:reda.057.001.01 AnyBIC"`
	NmAndAdr NameAndAddress5  `xml:"urn:iso:std:iso:20022:tech:xsd:reda.057.001.01 NmAndAdr"`
	Ctry     CountryCode      `xml:"urn:iso:std:iso:20022:tech:xsd:reda.057.001.01 Ctry"`
}

type PartyOrCurrency1Choice struct {
	Dpstry   PartyIdentification63 `xml:"urn:iso:std:iso:20022:tech:xsd:reda.057.001.01 Dpstry"`
	SttlmCcy ActiveCurrencyCode    `xml:"urn:iso:std:iso:20022:tech:xsd:reda.057.001.01 SttlmCcy"`
}
...
type Purpose3Choice struct {
	SctiesPurpCd ExternalSecuritiesPurpose1Code `xml:"urn:iso:std:iso:20022:tech:xsd:reda.057.001.01 SctiesPurpCd"`
	Prtry        GenericIdentification1         `xml:"urn:iso:std:iso:20022:tech:xsd:reda.057.001.01 Prtry"`
}
