...
type AlternateSecurityIdentification1 struct {
	...
	DmstIdSrc  CountryCode `xml:"urn:swift:xsd:reda.002.001.04 DmstIdSrc"`
	PrtryIdSrc Max35Text   `xml:"urn:swift:xsd:reda.002.001.04 PrtryIdSrc"`
}
...
type Charge15 struct {
	Tp              ChargeType9Code                  `xml:"urn:swift:xsd:reda.002.001.04 Tp"`
	XtndedTp        Extended350Code                  `xml:"urn:swift:xsd:reda.002.001.04 XtndedTp"`
	Amt             ActiveCurrencyAnd13DecimalAmount `xml:"urn:swift:xsd:reda.002.001.04 Amt"`
	Rate            float64                          `xml:"urn:swift:xsd:reda.002.001.04 Rate"`
...
type DateAndDateTime1Choice struct {
	Dt   ISODate     `xml:"urn:swift:xsd:reda.002.001.04 Dt"`
	DtTm ISODateTime `xml:"urn:swift:xsd:reda.002.001.04 DtTm"`
}
...
type DateOrDateTimePeriodChoice struct {
	Dt   DatePeriodDetails     `xml:"urn:swift:xsd:reda.002.001.04 Dt"`
	DtTm DateTimePeriodDetails `xml:"urn:swift:xsd:reda.002.001.04 DtTm"`
}
...
type PartyIdentification2Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:swift:xsd:reda.002.001.04 BICOrBEI"`
	PrtryId  GenericIdentification1 `xml:"urn:swift:xsd:reda.002.001.04 PrtryId"`
	NmAndAdr NameAndAddress5        `xml:"urn:swift:xsd:reda.002.001.04 NmAndAdr"`
}
...
type SecurityIdentification3Choice struct {
	ISIN        ISINIdentifier                        `xml:"urn:swift:xsd:reda.002.001.04 ISIN"`
	SEDOL       string                                `xml:"urn:swift:xsd:reda.002.001.04 SEDOL"`
	CUSIP       string                                `xml:"urn:swift:xsd:reda.002.001.04 CUSIP"`
	RIC         RICIdentifier                         `xml:"urn:swift:xsd:reda.002.001.04 RIC"`
	TckrSymb    TickerIdentifier                      `xml:"urn:swift:xsd:reda.002.001.04 TckrSymb"`
	Blmbrg      BloombergIdentifier                   `xml:"urn:swift:xsd:reda.002.001.04 Blmbrg"`
	CTA         ConsolidatedTapeAssociationIdentifier `xml:"urn:swift:xsd:reda.002.001.04 CTA"`
	QUICK       string                                `xml:"urn:swift:xsd:reda.002.001.04 QUICK"`
	Wrtppr      string                                `xml:"urn:swift:xsd:reda.002.001.04 Wrtppr"`
	Dtch        string                                `xml:"urn:swift:xsd:reda.002.001.04 Dtch"`
	Vlrn        string                                `xml:"urn:swift:xsd:reda.002.001.04 Vlrn"`
	SCVM        string                                `xml:"urn:swift:xsd:reda.002.001.04 SCVM"`
	Belgn       string                                `xml:"urn:swift:xsd:reda.002.001.04 Belgn"`
	Cmon        EuroclearClearstreamIdentifier        `xml:"urn:swift:xsd:reda.002.001.04 Cmon"`
	OthrPrtryId AlternateSecurityIdentification1      `xml:"urn:swift:xsd:reda.002.001.04 OthrPrtryId"`
}
...
type Tax17 struct {
	Tp           TaxType12Code                                `xml:"urn:swift:xsd:reda.002.001.04 Tp"`
	XtndedTp     Extended350Code                              `xml:"urn:swift:xsd:reda.002.001.04 XtndedTp"`
	Amt          []ActiveOrHistoricCurrencyAnd13DecimalAmount `xml:"urn:swift:xsd:reda.002.001.04 Amt,omitempty"`
	Rate         float64                                      `xml:"urn:swift:xsd:reda.002.001.04 Rate,omitempty"`
	Ctry         CountryCode                                  `xml:"urn:swift:xsd:reda.002.001.04 Ctry"`
...
type UnitPrice15 struct {
	Tp                         TypeOfPrice9Code                           `xml:"urn:swift:xsd:reda.002.001.04 Tp"`
	XtndedTp                   Extended350Code                            `xml:"urn:swift:xsd:reda.002.001.04 XtndedTp"`
