...
type Investment1Choice struct {
	UscrdCshDpst   Deposit1                         `xml:"urn:iso:std:iso:20022:tech:xsd:auth.061.001.01 UscrdCshDpst"`
	CntrlBkDpst    Deposit1                         `xml:"urn:iso:std:iso:20022:tech:xsd:auth.061.001.01 CntrlBkDpst"`
	RpAgrmt        RepurchaseAgreement2             `xml:"urn:iso:std:iso:20022:tech:xsd:auth.061.001.01 RpAgrmt"`
	OthrInvstmts   OtherInvestment1                 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.061.001.01 OthrInvstmts"`
	OutrghtInvstmt SecurityIdentificationAndAmount1 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.061.001.01 OutrghtInvstmt"`
}
...
type RepurchaseAgreementType3Choice struct {
	SpcfcColl SpecificCollateral2 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.061.001.01 SpcfcColl"`
	GnlColl   GeneralCollateral3  `xml:"urn:iso:std:iso:20022:tech:xsd:auth.061.001.01 GnlColl"`
}
