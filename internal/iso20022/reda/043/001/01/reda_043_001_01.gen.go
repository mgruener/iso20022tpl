...
type AddressType3Choice struct {
	Cd    AddressType2Code        `xml:"urn:iso:std:iso:20022:tech:xsd:reda.043.001.01 Cd"`
	Prtry GenericIdentification30 `xml:"urn:iso:std:iso:20022:tech:xsd:reda.043.001.01 Prtry"`
}
...
type CodeOrProprietary1Choice struct {
	Cd    Max4Text                `xml:"urn:iso:std:iso:20022:tech:xsd:reda.043.001.01 Cd"`
	Prtry GenericIdentification13 `xml:"urn:iso:std:iso:20022:tech:xsd:reda.043.001.01 Prtry"`
}
...
type DatePeriod3Choice struct {
	FrDt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:reda.043.001.01 FrDt"`
	ToDt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:reda.043.001.01 ToDt"`
	FrToDt DatePeriod2 `xml:"urn:iso:std:iso:20022:tech:xsd:reda.043.001.01 FrToDt"`
	Dt     ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:reda.043.001.01 Dt"`
}
...
type ErrorHandling3Choice struct {
	Cd    ExternalSystemErrorHandling1Code `xml:"urn:iso:std:iso:20022:tech:xsd:reda.043.001.01 Cd"`
	Prtry Max35Text                        `xml:"urn:iso:std:iso:20022:tech:xsd:reda.043.001.01 Prtry"`
}
...
type PartyAuditTrailOrError1Choice struct {
	PtyAudtTrlRpt []PartyAuditTrailReport3 `xml:"urn:iso:std:iso:20022:tech:xsd:reda.043.001.01 PtyAudtTrlRpt"`
	OprlErr       []ErrorHandling5         `xml:"urn:iso:std:iso:20022:tech:xsd:reda.043.001.01 OprlErr"`
}

type PartyAuditTrailOrError2Choice struct {
	AudtTrl []PartyAuditTrail1 `xml:"urn:iso:std:iso:20022:tech:xsd:reda.043.001.01 AudtTrl"`
	BizErr  []ErrorHandling5   `xml:"urn:iso:std:iso:20022:tech:xsd:reda.043.001.01 BizErr"`
}
...
type PartyIdentification120Choice struct {
	AnyBIC   AnyBICDec2014Identifier `xml:"urn:iso:std:iso:20022:tech:xsd:reda.043.001.01 AnyBIC"`
	PrtryId  GenericIdentification36 `xml:"urn:iso:std:iso:20022:tech:xsd:reda.043.001.01 PrtryId"`
	NmAndAdr NameAndAddress5         `xml:"urn:iso:std:iso:20022:tech:xsd:reda.043.001.01 NmAndAdr"`
}
...
type SystemPartyType1Choice struct {
	Cd    ExternalSystemPartyType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:reda.043.001.01 Cd"`
	Prtry Max35Text                    `xml:"urn:iso:std:iso:20022:tech:xsd:reda.043.001.01 Prtry"`
}

type TechnicalIdentification2Choice struct {
	BICFI   BICFIDec2014Identifier `xml:"urn:iso:std:iso:20022:tech:xsd:reda.043.001.01 BICFI"`
	TechAdr Max256Text             `xml:"urn:iso:std:iso:20022:tech:xsd:reda.043.001.01 TechAdr"`
}
...
type UpdateLogPartyRecord1Choice struct {
	Adr          UpdateLogAddress1                 `xml:"urn:iso:std:iso:20022:tech:xsd:reda.043.001.01 Adr"`
	CtctDtls     UpdateLogContact1                 `xml:"urn:iso:std:iso:20022:tech:xsd:reda.043.001.01 CtctDtls"`
	OpngDt       UpdateLogDate1                    `xml:"urn:iso:std:iso:20022:tech:xsd:reda.043.001.01 OpngDt"`
	ClsgDt       UpdateLogDate1                    `xml:"urn:iso:std:iso:20022:tech:xsd:reda.043.001.01 ClsgDt"`
	Tp           UpdateLogSystemPartyType1         `xml:"urn:iso:std:iso:20022:tech:xsd:reda.043.001.01 Tp"`
	TechAdr      UpdateLogTechnicalAddress1        `xml:"urn:iso:std:iso:20022:tech:xsd:reda.043.001.01 TechAdr"`
	MktSpcfcAttr UpdateLogMarketSpecificAttribute1 `xml:"urn:iso:std:iso:20022:tech:xsd:reda.043.001.01 MktSpcfcAttr"`
	Nm           UpdateLogPartyName1               `xml:"urn:iso:std:iso:20022:tech:xsd:reda.043.001.01 Nm"`
	ResTp        UpdateLogResidenceType1           `xml:"urn:iso:std:iso:20022:tech:xsd:reda.043.001.01 ResTp"`
	LckSts       UpdateLogPartyLockStatus1         `xml:"urn:iso:std:iso:20022:tech:xsd:reda.043.001.01 LckSts"`
	Rstrctn      UpdateLogRestriction1             `xml:"urn:iso:std:iso:20022:tech:xsd:reda.043.001.01 Rstrctn"`
	Othr         []UpdateLogProprietary1           `xml:"urn:iso:std:iso:20022:tech:xsd:reda.043.001.01 Othr"`
}
