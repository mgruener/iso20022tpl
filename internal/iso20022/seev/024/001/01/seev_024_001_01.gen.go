...
type AlternateSecurityIdentification3 struct {
	...
	DmstIdSrc  CountryCode `xml:"urn:iso:std:iso:20022:tech:xsd:seev.024.001.01 DmstIdSrc"`
	PrtryIdSrc Max35Text   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.024.001.01 PrtryIdSrc"`
}
...
type BeneficiaryCertificationType1FormatChoice struct {
	Cd    BeneficiaryCertificationType1Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.024.001.01 Cd"`
	Prtry GenericIdentification13           `xml:"urn:iso:std:iso:20022:tech:xsd:seev.024.001.01 Prtry"`
}

type CashAccountIdentification1Choice struct {
	IBAN     IBANIdentifier                  `xml:"urn:iso:std:iso:20022:tech:xsd:seev.024.001.01 IBAN"`
	BBAN     BBANIdentifier                  `xml:"urn:iso:std:iso:20022:tech:xsd:seev.024.001.01 BBAN"`
	UPIC     UPICIdentifier                  `xml:"urn:iso:std:iso:20022:tech:xsd:seev.024.001.01 UPIC"`
	DmstAcct SimpleIdentificationInformation `xml:"urn:iso:std:iso:20022:tech:xsd:seev.024.001.01 DmstAcct"`
}
...
type CorporateActionInformationStatus1Choice struct {
	PrcdSts  CorporateActionInformationProcessingStatus1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.024.001.01 PrcdSts"`
	RjctdSts CorporateActionInformationRejectedStatus1   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.024.001.01 RjctdSts"`
}
...
type PartyIdentification2Choice struct {
	BICOrBEI AnyBICIdentifier       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.024.001.01 BICOrBEI"`
	PrtryId  GenericIdentification1 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.024.001.01 PrtryId"`
	NmAndAdr NameAndAddress5        `xml:"urn:iso:std:iso:20022:tech:xsd:seev.024.001.01 NmAndAdr"`
}

type PersonIdentificationType3Choice struct {
	Cd    PersonIdentificationType3Code `xml:"urn:iso:std:iso:20022:tech:xsd:seev.024.001.01 Cd"`
	Prtry GenericIdentification13       `xml:"urn:iso:std:iso:20022:tech:xsd:seev.024.001.01 Prtry"`
}
...
type ProceedsDelivery1 struct {
	SctiesAcctId Max35Text                        `xml:"urn:iso:std:iso:20022:tech:xsd:seev.024.001.01 SctiesAcctId"`
	CshAcctId    CashAccountIdentification1Choice `xml:"urn:iso:std:iso:20022:tech:xsd:seev.024.001.01 CshAcctId"`
...
type ProcessedStatus5FormatChoice struct {
	Cd    ProcessedStatus5Code    `xml:"urn:iso:std:iso:20022:tech:xsd:seev.024.001.01 Cd"`
	Prtry GenericIdentification13 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.024.001.01 Prtry"`
}
...
type RejectionReason15FormatChoice struct {
	Cd    RejectionReason15Code   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.024.001.01 Cd"`
	Prtry GenericIdentification13 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.024.001.01 Prtry"`
}

type SecurityIdentification7 struct {
	ISIN   ISINIdentifier                   `xml:"urn:iso:std:iso:20022:tech:xsd:seev.024.001.01 ISIN"`
	OthrId AlternateSecurityIdentification3 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.024.001.01 OthrId"`
...
type UnitOrFaceAmount1Choice struct {
	Unit    float64                 `xml:"urn:iso:std:iso:20022:tech:xsd:seev.024.001.01 Unit"`
	FaceAmt ActiveCurrencyAndAmount `xml:"urn:iso:std:iso:20022:tech:xsd:seev.024.001.01 FaceAmt"`
}
