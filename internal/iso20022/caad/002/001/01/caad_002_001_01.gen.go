...
type EncryptedData1Choice struct {
	BinryData   Max100KBinary `xml:"urn:iso:std:iso:20022:tech:xsd:caad.002.001.01 BinryData"`
	HexBinryVal string        `xml:"urn:iso:std:iso:20022:tech:xsd:caad.002.001.01 HexBinryVal"`
}
...
type Recipient5Choice struct {
	IssrAndSrlNb IssuerAndSerialNumber1 `xml:"urn:iso:std:iso:20022:tech:xsd:caad.002.001.01 IssrAndSrlNb"`
	KeyIdr       KEKIdentifier2         `xml:"urn:iso:std:iso:20022:tech:xsd:caad.002.001.01 KeyIdr"`
}

type Recipient7Choice struct {
	KeyTrnsprt KeyTransport6  `xml:"urn:iso:std:iso:20022:tech:xsd:caad.002.001.01 KeyTrnsprt"`
	KEK        KEK6           `xml:"urn:iso:std:iso:20022:tech:xsd:caad.002.001.01 KEK"`
	KeyIdr     KEKIdentifier6 `xml:"urn:iso:std:iso:20022:tech:xsd:caad.002.001.01 KeyIdr"`
}
...
type TransactionIdentification10 struct {
	...
	RtrvlRefNb          Exact12Text                         `xml:"urn:iso:std:iso:20022:tech:xsd:caad.002.001.01 RtrvlRefNb"`
...
type TransactionLifeCycleIdentification1 struct {
	Id              Exact15Text       `xml:"urn:iso:std:iso:20022:tech:xsd:caad.002.001.01 Id"`
