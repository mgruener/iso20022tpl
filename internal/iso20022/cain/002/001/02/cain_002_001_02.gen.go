...
type EncryptedData1Choice struct {
	BinryData   Max100KBinary `xml:"urn:iso:std:iso:20022:tech:xsd:cain.002.001.02 BinryData"`
	HexBinryVal string        `xml:"urn:iso:std:iso:20022:tech:xsd:cain.002.001.02 HexBinryVal"`
}
...
type OriginalDataElements1 struct {
	...
	RtrvlRefNb          Exact12Text                         `xml:"urn:iso:std:iso:20022:tech:xsd:cain.002.001.02 RtrvlRefNb"`
...
type Recipient5Choice struct {
	IssrAndSrlNb IssuerAndSerialNumber1 `xml:"urn:iso:std:iso:20022:tech:xsd:cain.002.001.02 IssrAndSrlNb"`
	KeyIdr       KEKIdentifier2         `xml:"urn:iso:std:iso:20022:tech:xsd:cain.002.001.02 KeyIdr"`
}

type Recipient7Choice struct {
	KeyTrnsprt KeyTransport6  `xml:"urn:iso:std:iso:20022:tech:xsd:cain.002.001.02 KeyTrnsprt"`
	KEK        KEK6           `xml:"urn:iso:std:iso:20022:tech:xsd:cain.002.001.02 KEK"`
	KeyIdr     KEKIdentifier6 `xml:"urn:iso:std:iso:20022:tech:xsd:cain.002.001.02 KeyIdr"`
}
...
type TransactionLifeCycleIdentification1 struct {
	Id              Exact15Text       `xml:"urn:iso:std:iso:20022:tech:xsd:cain.002.001.02 Id"`
