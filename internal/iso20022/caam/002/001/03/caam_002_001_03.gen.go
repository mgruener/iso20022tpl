...
type ATMCommandParameters3Choice struct {
	ATMReqrdGblSts  ATMStatus1Code             `xml:"urn:iso:std:iso:20022:tech:xsd:caam.002.001.03 ATMReqrdGblSts"`
	XpctdMsgFctn    MessageFunction8Code       `xml:"urn:iso:std:iso:20022:tech:xsd:caam.002.001.03 XpctdMsgFctn"`
	ReqrdCfgtnParam ATMConfigurationParameter1 `xml:"urn:iso:std:iso:20022:tech:xsd:caam.002.001.03 ReqrdCfgtnParam"`
	ReqrdSctySchme  ATMSecurityScheme4Code     `xml:"urn:iso:std:iso:20022:tech:xsd:caam.002.001.03 ReqrdSctySchme"`
	SctyDvc         ATMCommandParameters1      `xml:"urn:iso:std:iso:20022:tech:xsd:caam.002.001.03 SctyDvc"`
	Key             ATMConfigurationParameter2 `xml:"urn:iso:std:iso:20022:tech:xsd:caam.002.001.03 Key"`
}
...
type GeographicLocation1Choice struct {
	GeogcCordints GeographicCoordinates1 `xml:"urn:iso:std:iso:20022:tech:xsd:caam.002.001.03 GeogcCordints"`
	UTMCordints   UTMCoordinates1        `xml:"urn:iso:std:iso:20022:tech:xsd:caam.002.001.03 UTMCordints"`
}
...
type Recipient4Choice struct {
	KeyTrnsprt KeyTransport4  `xml:"urn:iso:std:iso:20022:tech:xsd:caam.002.001.03 KeyTrnsprt"`
	KEK        KEK4           `xml:"urn:iso:std:iso:20022:tech:xsd:caam.002.001.03 KEK"`
	KeyIdr     KEKIdentifier2 `xml:"urn:iso:std:iso:20022:tech:xsd:caam.002.001.03 KeyIdr"`
}

type Recipient5Choice struct {
	IssrAndSrlNb IssuerAndSerialNumber1 `xml:"urn:iso:std:iso:20022:tech:xsd:caam.002.001.03 IssrAndSrlNb"`
	KeyIdr       KEKIdentifier2         `xml:"urn:iso:std:iso:20022:tech:xsd:caam.002.001.03 KeyIdr"`
}
