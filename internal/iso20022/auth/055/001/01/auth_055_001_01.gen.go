...
type MarginType2Choice struct {
	Cd    MarginType2Code         `xml:"urn:iso:std:iso:20022:tech:xsd:auth.055.001.01 Cd"`
	Prtry GenericIdentification36 `xml:"urn:iso:std:iso:20022:tech:xsd:auth.055.001.01 Prtry"`
}
