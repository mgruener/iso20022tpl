...
type AgreementFramework1Choice struct {
	AgrmtFrmwk AgreementFramework1Code `xml:"urn:iso:std:iso:20022:tech:xsd:colr.003.001.04 AgrmtFrmwk"`
	PrtryId    GenericIdentification30 `xml:"urn:iso:std:iso:20022:tech:xsd:colr.003.001.04 PrtryId"`
}
...
type CollateralAccountIdentificationType2Choice struct {
	...
	Prtry GenericIdentification36    `xml:"urn:iso:std:iso:20022:tech:xsd:colr.003.001.04 Prtry"`
}
...
type CollateralBalance1Choice struct {
	TtlColl         ActiveCurrencyAndAmount `xml:"urn:iso:std:iso:20022:tech:xsd:colr.003.001.04 TtlColl"`
	CollDtls        Collateral1             `xml:"urn:iso:std:iso:20022:tech:xsd:colr.003.001.04 CollDtls"`
	SgrtdIndpdntAmt MarginCollateral1       `xml:"urn:iso:std:iso:20022:tech:xsd:colr.003.001.04 SgrtdIndpdntAmt"`
}
...
type DateAndDateTimeChoice struct {
	Dt   ISODate     `xml:"urn:iso:std:iso:20022:tech:xsd:colr.003.001.04 Dt"`
	DtTm ISODateTime `xml:"urn:iso:std:iso:20022:tech:xsd:colr.003.001.04 DtTm"`
}
...
type ExpectedCollateral2Choice struct {
	XpctdCollDtls   ExpectedCollateral2         `xml:"urn:iso:std:iso:20022:tech:xsd:colr.003.001.04 XpctdCollDtls"`
	SgrtdIndpdntAmt ExpectedCollateralMovement2 `xml:"urn:iso:std:iso:20022:tech:xsd:colr.003.001.04 SgrtdIndpdntAmt"`
}
...
type MarginCallResult2Choice struct {
	MrgnCallRsltDtls MarginCallResult2 `xml:"urn:iso:std:iso:20022:tech:xsd:colr.003.001.04 MrgnCallRsltDtls"`
	MrgnCallAmt      Result1           `xml:"urn:iso:std:iso:20022:tech:xsd:colr.003.001.04 MrgnCallAmt"`
	SgrtdIndpdntAmt  Result1           `xml:"urn:iso:std:iso:20022:tech:xsd:colr.003.001.04 SgrtdIndpdntAmt"`
}
...
type MarginRequirement1Choice struct {
	MrgnRqrmnt            Requirement1       `xml:"urn:iso:std:iso:20022:tech:xsd:colr.003.001.04 MrgnRqrmnt"`
	SgrtdIndpdntAmtRqrmnt MarginRequirement1 `xml:"urn:iso:std:iso:20022:tech:xsd:colr.003.001.04 SgrtdIndpdntAmtRqrmnt"`
}

type MarginTerms1Choice struct {
	MrgnDtls            Margin1                            `xml:"urn:iso:std:iso:20022:tech:xsd:colr.003.001.04 MrgnDtls"`
	SgrtdIndpdntAmtMrgn SegregatedIndependentAmountMargin1 `xml:"urn:iso:std:iso:20022:tech:xsd:colr.003.001.04 SgrtdIndpdntAmtMrgn"`
}
...
type PartyIdentification100Choice struct {
	AnyBIC   AnyBICIdentifier        `xml:"urn:iso:std:iso:20022:tech:xsd:colr.003.001.04 AnyBIC"`
	PrtryId  GenericIdentification36 `xml:"urn:iso:std:iso:20022:tech:xsd:colr.003.001.04 PrtryId"`
	NmAndAdr NameAndAddress6         `xml:"urn:iso:std:iso:20022:tech:xsd:colr.003.001.04 NmAndAdr"`
}
